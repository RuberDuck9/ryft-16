...
- AD1 [0000000000000011] [0003] : add the value typed out in argument 1 and the value held at the address specified in arguments 2, and save it to the address specified in argument 3   
- AD2 [0000000000000100] [0004] : add the value typed out in argument 2 and the value held at the address specified in arguments 1, and save it to the address specified in argument 3    
