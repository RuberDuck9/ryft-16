...
- LOR [0000000000010110] [0016] : load the value held at the address specified in arguments 1 from ram and save it at the address specified in argument 3, argument 2 should be NULL  
